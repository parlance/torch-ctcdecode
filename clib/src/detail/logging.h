...
#ifndef DETAIL_LOGGING_H_
#define DETAIL_LOGGING_H_
...
#define _TF_LOG_INFO internal::LogMessage(__FILE__, __LINE__, tensorflow::INFO)
#define _TF_LOG_WARNING                                                        \
  internal::LogMessage(__FILE__, __LINE__, tensorflow::WARNING)
#define _TF_LOG_ERROR                                                          \
  internal::LogMessage(__FILE__, __LINE__, tensorflow::ERROR)
#define _TF_LOG_FATAL internal::LogMessageFatal(__FILE__, __LINE__)
...
// of VLOG
#define VLOG_IS_ON(lvl) ((lvl) <= internal::LogMessage::MinVLogLevel())
#endif

#define VLOG(lvl)                                                              \
  if (TF_PREDICT_FALSE(VLOG_IS_ON(lvl)))                                       \
  internal::LogMessage(__FILE__, __LINE__, tensorflow::INFO)
...
#define TF_DEFINE_CHECK_OP_IMPL(name, op)                                      \
  ...
  inline std::string *name##Impl(const T1 &v1, const T2 &v2,                   \
    ...
    if (TF_PREDICT_TRUE(v1 op v2))                                             \
      ...
      return internal::MakeCheckOpString(v1, v2, exprtext);                    \
  }                                                                            \
...
#define CHECK_OP_LOG(name, op, val1, val2)                                     \
  while (internal::CheckOpString _result = internal::name##Impl(               \
             internal::GetReferenceableValue(val1),                            \
             internal::GetReferenceableValue(val2), #val1 " " #op " " #val2))  \
  internal::LogMessageFatal(__FILE__, __LINE__) << *(_result.str_)
...
#define CHECK_NOTNULL(val)                                                     \
  internal::CheckNotNull(__FILE__, __LINE__, "'" #val "' Must be non NULL",    \
                         (val))
