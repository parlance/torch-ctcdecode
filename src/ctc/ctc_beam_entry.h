...
#ifndef CTC_CTC_BEAM_ENTRY_H_
#define CTC_CTC_BEAM_ENTRY_H_
...
template <class CTCBeamState = EmptyBeamState> struct BeamEntry {
...
template <class CTCBeamState = EmptyBeamState> class BeamComparer {
public:
